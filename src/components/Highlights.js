...
const Highlights = ({stats}) => {
  return (
    <div className='bg-slate-800 text-slate-700 flex flex-col justify-start items-center'>
      <h2 className='testx-sm mt-2 '>{stats.title}</h2>
      <div className='mt-2'>
...

      {
        ...
        (
            <div className=' mt-2 flex'>
                ...
                <div className='ms-2 text-slate-700'>{stats.direction}</div> 
